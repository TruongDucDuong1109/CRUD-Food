...
const rating = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    let finalproduct = await Product.findByIdAndUpdate(proId, {
...
module.exports = { createProduct, addToWishlist, getaProduct, getAllProduct, updateProduct, deleteProduct, rating,uploadImages };
